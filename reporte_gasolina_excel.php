<?php
// =============================================
//  reporte_gasolina_excel.php — Exportación a Excel Visual
// =============================================
...
$filename = "reporte_gasolina_" . date('Y-m-d_H-i') . ".xls";
...
<head>
    ...
    <xml>
        <x:ExcelWorkbook>
            <x:ExcelWorksheets>
                <x:ExcelWorksheet>
                    <x:Name>Cargas de Gasolina</x:Name>
                    <x:WorksheetOptions>
                        <x:DisplayGridlines/>
                    </x:WorksheetOptions>
                </x:ExcelWorksheet>
...
<body>
    ...
    <table>
        <tr>
            <td colspan="10" class="title">Reporte de Cargas de Gasolina</td>
        </tr>
        <tr><td colspan="10"></td></tr>
        <tr>
            <td colspan="10" class="sub-info"><b><?= htmlspecialchars($auto_info) ?></b></td>
        </tr>
        <tr><td colspan="10"></td></tr>
        <tr>
        ...
        <tbody>
            <?php if (empty($registros)): ?>
                <tr>
                    <td colspan="10" style="text-align: center;">No hay registros de cargas de gasolina para este filtro.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($registros as $row): ?>
                    <tr>
                        ...
                        <td><?= number_format((float)$row['litros'], 2) ?> L</td>
                        <td><b>$<?= number_format((float)$row['costo_total'], 2) ?></b></td>
                        <td><?= htmlspecialchars($row['gasolinera'] ?? '-') ?></td>
